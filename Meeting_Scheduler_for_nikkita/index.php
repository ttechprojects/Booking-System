        ...
        <div class="row">
            <div class="col-sm-3 col-md-4 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li>
                        <div id="meeting-form" style=" position:relative;">
                            <form class="m-form" method="post" action="php/clashes.php">
                               ...
                               <!--- <div class="text-form">Room Number
                                   ...
                                   <?php
                                        ...
                                        /*$result = $conn->query("select r_id from booking");                                            
				...
				Other<input type="radio" name="rec_time" value="other"><br>-->
                    ...
                    <li>
                        <div id="cm-form" style="display:none; position:relative; height: 400px;">
                            <form class="cm-form" action="php/contentup.php" method="get">
                                <div class="text-form">Upload Image/Video<input class="file-path text-field" type="file" name="userfile" accept="media_type" required><br></div>
                              <div class="text-form">Screen Number<br>
                                    <div class="c-box"><input class="check-box" type="checkbox" name="screen" value="1">Screen - 1 &nbsp; &nbsp;&nbsp; &nbsp;
                                        <input class="check-box" type="checkbox" name="screen" value="2">Screen - 2</div>
                                    <div class="c-box"><input class="check-box" type="checkbox" name="screen3" value="3">Screen - 3 &nbsp; &nbsp;&nbsp; &nbsp;
                                        <input class="check-box" type="checkbox" name="screen" value="4">Screen - 4</div>

                                    <div class="c-box"><input class="check-box" type="checkbox" name="screen" value="5">Screen - 5 &nbsp; &nbsp;&nbsp; &nbsp;
                                        <input class="check-box" type="checkbox" name="screen" value="6">Screen - 6</div>

                                    <div class="c-box"><input class="check-box" type="checkbox" name="screen" value="7">Screen - 7 &nbsp; &nbsp;&nbsp; &nbsp;
                                        <input class="check-box" type="checkbox" name="screen" value="8">Screen - 8</div>
                                    <div class="s-all"><input class="select-all" type="checkbox" name="screen" value="0">Select All</div>
                                </div>
                                ...
                                <div class="form-sub"><input class="form-submit" type="submit" />Submit</div>
                                <?php
    ...
    <div class="container-fluid" id="view-meeting" style="display:none;">
		...
		border-top-right-radius:15px;border-bottom-right-radius:15px; box-shadow:2px 2px 0px 0px lightgray inset;  padding-top:50px;margin-top:50px;">
                        <div id="edit-form" style="position:relative;">
                           <form class="e-form" method="request" action= "" style="min-height:400px;">
                                ...
                                $sql = "SELECT s_id, s_name, m_name, guests, s_time, e_time, r_id, contact, email FROM booking where m_name like '$name';";
                                ...
                                if ($result = mysqli_query($con, $sql))
                                {
                                    ...
                                    <div class="text-form">Room Name<input class="text-field" type="text" name="r_id" readonly value="<?php echo '' .$row['r_id']?>"><br></div>
                                    <div class="text-form">Contact Number<input class="text-field editable" type="text" name="id" value="<?php      echo '' .$row['contact']; ?>" readonly required></div>
                                    <div class="text-form">Email<input class="text-field editable" type="text" name="id" value="<?php  echo '' .$row['email']; ?>" readonly required></div>
                                    <br>
