<?php
	...
	$con=mysqli_connect("localhost","root","","ekbooking");
			...
			$sql="UPDATE booking SET s_name='$emp_name', m_name='$meeting_name', date='$date', guests=$nog, s_time='$s_time', e_time='$e_time', contact='$cont' WHERE m_name like '$meeting_name';";
