<?php
    ...
    //{
        ...
        $ms=date("Y-m-d H:i:s",strtotime($meet_s));
        $me=date("Y-m-d H:i:s",strtotime($meet_e));

        $room_no=array_fill(0,20,true);

        $sql1="SELECT r_id,avail FROM rooms;";
        $sql2="INSERT INTO booking VALUES('$emp_name','$staff_id','$meeting_name',$nog,'$ms','$me',$cont,'$email');";
