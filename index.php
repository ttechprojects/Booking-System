...
echo "<script>
	...
	$(document).ready(function() {
        ...
        if (event.title) {
            $('#view-meeting').toggle();
           // $('#view-details').load('php/view-details.php');
            $('#add-meeting').toggle();
            return false;
        }
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top"  style="position:fixed;"><!--Navigation bar at the top-->
        ...
        <div class="row">
            <div class="col-sm-3 col-md-4 sidebar">
                <ul class="nav nav-sidebar">
				    ...
				    <li><div id="meeting-form" style="display:none; position:relative;">
			             <form class="m-form" action="FS1" method="get">
    ...
    <div class="container-fluid" id="view-meeting" style="display: none;">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-4 sidebar " style="background-color:lightgray;">
          <ul class="nav nav-sidebar">
                              <li class="active" style="margin-top:-21px; margin-bottom: -50px;"><a href="index.html" class="button4" >Back</a></li>
		...
		border-top-right-radius:15px;border-bottom-right-radius:15px; box-shadow:2px 2px 0px 0px lightgray inset;  padding-top:50px;margin-top:50px;">
            <div id="edit-form" style="position:relative;">
			         <form class="e-form" action="FS1" method="get" style="min-height:400px">
                         ...
                         <div class="text-form">Meeting Name<input class="text-field editable" type="text" name="m_name" value="<?php echo 'A Meeting'; ?>" readonly required ><br></div>
                        <div class="text-form ">Booked By<input class="text-field editable" type="text" name="b_by" readonly required><br></div>
                        <div class="text-form">Staff Number<input class="text-field editable" type="text" name="s_id" readonly required><br></div>
                        <div class="text-form date-form">Date<input class="text-field editable" type="date" name="date" readonly required><br></div>
                        <div class="text-form">Start Time<input class="text-field editable" type="time" name="start" readonly required><br></div>
                        <div class="text-form">End Time<input class="text-field editable" type="time" name="end" readonly required><br></div>
                        <div class="text-form">No.of Attendees<input class="text-field editable" type="text" name="guests" readonly><br></div>
                        <div class="text-form">Room Number<input class="text-field editable" type="text" name="r_no" readonly><br></div>
                        <div class="text-form">Contact Number<input class="text-field editable" type="text" name="id" readonly required></div>
                        <br>
